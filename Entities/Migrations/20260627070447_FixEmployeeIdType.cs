...
{
    /// <inheritdoc />
    public partial class FixEmployeeIdType : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppJob", x => x.JobID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RolePermissions_IdentityRole_RoleId1",
                        column: x => x.RoleId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductLimit_ProductID",
                table: "ProductLimit",
                column: "ProductID");
